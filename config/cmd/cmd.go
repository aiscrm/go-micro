...
import (
	...
	"github.com/aiscrm/go-micro/v2/client/grpc"
	"github.com/aiscrm/go-micro/v2/client/selector"
	"github.com/aiscrm/go-micro/v2/config"
	configSrc "github.com/aiscrm/go-micro/v2/config/source"
	configSrv "github.com/aiscrm/go-micro/v2/config/source/service"
	"github.com/aiscrm/go-micro/v2/debug/profile"
	"github.com/aiscrm/go-micro/v2/debug/profile/http"
	"github.com/aiscrm/go-micro/v2/debug/profile/pprof"
	"github.com/aiscrm/go-micro/v2/debug/trace"
	"github.com/aiscrm/go-micro/v2/logger"
	"github.com/aiscrm/go-micro/v2/registry"
	registrySrv "github.com/aiscrm/go-micro/v2/registry/service"
	"github.com/aiscrm/go-micro/v2/runtime"
	"github.com/aiscrm/go-micro/v2/server"
	"github.com/aiscrm/go-micro/v2/store"
	"github.com/aiscrm/go-micro/v2/transport"
	authutil "github.com/aiscrm/go-micro/v2/util/auth"
	"github.com/aiscrm/go-micro/v2/util/wrapper"

	// clients
	cgrpc "github.com/aiscrm/go-micro/v2/client/grpc"
	cmucp "github.com/aiscrm/go-micro/v2/client/mucp"

	// servers
	"github.com/micro/cli/v2"

	sgrpc "github.com/aiscrm/go-micro/v2/server/grpc"
	smucp "github.com/aiscrm/go-micro/v2/server/mucp"

	// brokers
	brokerHttp "github.com/aiscrm/go-micro/v2/broker/http"
	"github.com/aiscrm/go-micro/v2/broker/memory"
	"github.com/aiscrm/go-micro/v2/broker/nats"
	brokerSrv "github.com/aiscrm/go-micro/v2/broker/service"

	// registries
	"github.com/aiscrm/go-micro/v2/registry/etcd"
	"github.com/aiscrm/go-micro/v2/registry/mdns"
	rmem "github.com/aiscrm/go-micro/v2/registry/memory"
	regSrv "github.com/aiscrm/go-micro/v2/registry/service"

	// runtimes
	kRuntime "github.com/aiscrm/go-micro/v2/runtime/kubernetes"
	lRuntime "github.com/aiscrm/go-micro/v2/runtime/local"
	srvRuntime "github.com/aiscrm/go-micro/v2/runtime/service"

	// selectors
	"github.com/aiscrm/go-micro/v2/client/selector/dns"
	"github.com/aiscrm/go-micro/v2/client/selector/router"
	"github.com/aiscrm/go-micro/v2/client/selector/static"

	// transports
	thttp "github.com/aiscrm/go-micro/v2/transport/http"
	tmem "github.com/aiscrm/go-micro/v2/transport/memory"

	// stores
	memStore "github.com/aiscrm/go-micro/v2/store/memory"
	svcStore "github.com/aiscrm/go-micro/v2/store/service"

	// tracers
	// jTracer "github.com/aiscrm/go-micro/v2/debug/trace/jaeger"
	memTracer "github.com/aiscrm/go-micro/v2/debug/trace/memory"

	// auth
	jwtAuth "github.com/aiscrm/go-micro/v2/auth/jwt"
	svcAuth "github.com/aiscrm/go-micro/v2/auth/service"

	// auth providers
	"github.com/aiscrm/go-micro/v2/auth/provider/basic"
	"github.com/aiscrm/go-micro/v2/auth/provider/oauth"
)
