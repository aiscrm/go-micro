// Package kubernetes taken from https://github.com/aiscrm/go-micro/blob/master/debug/log/kubernetes/kubernetes.go
...
import (
	...
	"github.com/aiscrm/go-micro/v2/util/kubernetes/client"
	"github.com/aiscrm/go-micro/v2/util/log"
)
